...
def product(n, f):
    ...
    162
    """
    return 1 if n == 0 else f(n) * product(n - 1, f)
...
def accumulate(combiner, base, n, f):
    ...
    16
    """
    return base if n == 0 else combiner(f(n), accumulate(combiner, base, n - 1, f))
...
def get_the_cake(missions):
    ...
    ['Expr', 'Return']
    """
    return missions(lambda x: 2 * x)(lambda g: g)(0)(1)(2)(3)(4)
